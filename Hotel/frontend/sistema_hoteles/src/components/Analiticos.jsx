...
const Analiticos = () => {
    ...
    const fetchBusquedasPorPais = async () => {
        const response = await axios.get('http://localhost:8092/analiticos/registros/paises');
    ...
    const fetchEvolucionBusquedas = async () => {
        const response = await axios.get('http://localhost:8092/analiticos/registros/evolucion');
    ...
    const fetchTipoAcceso = async () => {
        const response = await axios.get('http://localhost:8092/analiticos/registros/tipoacceso');
    ...
    const handleSearch = async () => {
        ...
        try {
            const response = await axios.get(`http://localhost:8092/analiticos/filtrar?${params}`);
...
const handleUploadToDrive = () => {
    ...
    axios.post('http://localhost:8092/uploadToDrive', {
