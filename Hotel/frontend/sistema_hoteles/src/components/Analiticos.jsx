...
const Analiticos = () => {
    ...
    const fetchBusquedasPorPais = async () => {
        const response = await axios.get('http://localhost:8091/analiticos/registros/paises');
    ...
    const fetchEvolucionBusquedas = async () => {
        const response = await axios.get('http://localhost:8091/analiticos/registros/evolucion');
    ...
    const fetchTipoAcceso = async () => {
        const response = await axios.get('http://localhost:8091/analiticos/registros/tipoacceso');
    ...
    const handleSearch = async () => {
        ...
        try {
            const response = await axios.get(`http://localhost:8091/analiticos/filtrar?${params}`);
...
const handleUploadToDrive = () => {
    ...
    axios.post('http://localhost:8091/uploadToDrive', {
